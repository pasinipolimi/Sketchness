...
object ApplicationBuild extends Build {
	...
	val sketchnessResourcesSetting = sketchnessResources := Seq(
		...
		Resource("Javascript Libraries", "public/javascripts/lib/", "http://54.75.252.197/storage/libs.zip", true),
		Resource("CSS", "public/stylesheets", "http://54.75.252.197/storage/css.zip",true),
