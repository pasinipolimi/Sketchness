require(["Class", "Chat", "StateMachine", "Communicator", "Time", "Writer", "canvas/Painter", "jquery", "nouislider", "spectrum", "i18n", "howler", "snow", "jAjax"],
...
/**
* SKETCHER BOT 
* Simulate the sketcher replicating one of the the best segmentations for a given image (idselected)
*/
            ...
            if(xhr.readyState === 4){
                if(xhr.status >= 200 && xhr.status < 300 || xhr.status === 304){
                    ...
                    ctx.lineJoin = "round";
                    	...
                    	if(!(inRange(p.x, p.y, previousX, previousY, 20))){
                    		drawable = false;
                    	}
