...
public class ContourAggregator {
    ...
    public static boolean moreThan2Around(final WritableRaster raster, int x, int y){
        int counter = 0;
        if(raster.getSample(x-1,y-1,0) == 1){counter++;}
        if(raster.getSample(x-1,y,0) == 1){counter++;}
        if(raster.getSample(x-1,y+1,0) == 1){counter++;}
        if(raster.getSample(x,y-1,0) == 1){counter++;}
        if(raster.getSample(x,y+1,0) == 1){counter++;}
        if(raster.getSample(x+1,y-1,0) == 1){counter++;}
        if(raster.getSample(x+1,y,0) == 1){counter++;}
        if(raster.getSample(x+1,y+1,0) == 1){counter++;}
    ...
    public static int surroundedColor(final WritableRaster raster, int x, int y,int color){
        int counter = 0;
        if(raster.getSample(x-1,y-1,0) == color){counter++;}
        if(raster.getSample(x-1,y,0) == color){counter++;}
        if(raster.getSample(x-1,y+1,0) == color){counter++;}
        if(raster.getSample(x,y-1,0) == color){counter++;}
        if(raster.getSample(x,y+1,0) == color){counter++;}
        if(raster.getSample(x+1,y-1,0) == color){counter++;}
        if(raster.getSample(x+1,y,0) == color){counter++;}
        if(raster.getSample(x+1,y+1,0) == color){counter++;}
    ...
    public static boolean surroundedWithPoints(final WritableRaster raster, int x, int y){
        if(raster.getSample(x-1,y-1,0) != 1){return false;}
        if(raster.getSample(x-1,y,0) != 1){return false;}
        if(raster.getSample(x-1,y+1,0) != 1){return false;}
        if(raster.getSample(x,y-1,0) != 1){return false;}
        if(raster.getSample(x,y+1,0) != 1){return false;}
        if(raster.getSample(x+1,y-1,0) != 1){return false;}
        if(raster.getSample(x+1,y,0) != 1){return false;}
        if(raster.getSample(x+1,y+1,0) != 1){return false;}
