...
public class MyUsernamePasswordAuthProvider
    ...
    protected providers.MyLoginUsernamePasswordAuthUser buildLoginAuthUser(
        ...
        return new providers.MyLoginUsernamePasswordAuthUser(login.getPassword(),
                login.getEmail());
    }


    @Override
    protected providers.MyLoginUsernamePasswordAuthUser transformAuthUser(final MyUsernamePasswordAuthUser authUser, final Context context) {
        return new providers.MyLoginUsernamePasswordAuthUser(authUser.getEmail());
    }
